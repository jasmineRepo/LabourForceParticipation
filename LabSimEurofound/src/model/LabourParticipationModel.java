...
//	@Override
	public void buildObjects() {
        ...
        try {
            ...
            System.out.println( "ERROR: Class not found!  Check that the input.h2.db exists in the input folder.  If not, unzip the input.h2.zip file and store the resulting input.h2.db in the input folder!" + e.getMessage() );
        }
